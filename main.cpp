...
//  // Change to your own URDF file here, or give a path as command-line
//  argument const std::string urdf_filename = (argc <= 1)
//                                      ? PINOCCHIO_MODEL_DIR
//                                          +
...
//  Eigen::VectorXd a = Eigen::VectorXd::Zero(model.nv); // in rad/s² for the
//  UR5
